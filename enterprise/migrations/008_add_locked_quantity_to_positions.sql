...
-- Add constraint to ensure locked quantity doesn't exceed total quantity
ALTER TABLE positions
ADD CONSTRAINT check_locked_quantity CHECK (locked_quantity >= 0 AND locked_quantity <= quantity);
